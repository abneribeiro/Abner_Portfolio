  ...
  return (
    <div className={styles.main_container}>
      ...
      <div id="project" className={styles.project_container}>
        ...
        <p className={styles.text}><strong>I&apos;ll be updating the portfolio with other projects.</strong> You can find source code of all projects on my <a href="https://github.com/abneribeiro">GitHub</a>. </p>
